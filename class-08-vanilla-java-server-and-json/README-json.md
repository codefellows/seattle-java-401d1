# ![CF](http://i.imgur.com/7v5ASc8.png) JSON

## Resources
* [Java API for JSON](http://www.oracle.com/technetwork/articles/java/json-1973242.html)

## Configuration
* Create a new project in IntelliJ
* Create a new class in `src` called `Contact`
* Make sure the file `john.json` exists at the top of the project, beside their
  `src` directory (not inside it).
  
The test file should begin as simply as this:
...
Once you're set up a simple project and verified the tests run correctly, we're
ready to begin writing programs that interact with JSON!
